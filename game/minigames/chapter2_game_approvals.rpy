        ...
        vbox:
            ...
            frame:
                ...
                vbox:
                    ...
                    # ЗАЯВКИ (твой текст, оставляю как есть)
                    ...
                    hbox:
                        ...
                        textbutton "ОДОБРИТЬ ЗАЯВКУ":
                            ...
                            text_size 16
                            action [
                                SetVariable('current_question', current_question + 1),
                                SetVariable('stars', stars + 1),
                                SetVariable('last_result', "correct"),
                        ...
                        textbutton "ОТКЛОНИТЬ ЗАЯВКУ":
                            ...
                            action [
                                SetVariable('current_question', current_question + 1),
                                SetVariable('mistakes', mistakes + 1),
                                SetVariable('last_result', "wrong"),
                                SetVariable('apathy', apathy + 1),
                                If(current_question + 1 >= total_questions, Return(), None)
                            ]
